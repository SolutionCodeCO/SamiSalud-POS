...
<body>
	...
	<div class="relative sm:flex sm:flex-row justify-center max-h-[100vh] p-16 rounded-3xl shadow-xl">
		...
		<div class="flex justify-center self-center z-10">
			<div class="p-12 bg-white shadow-xl rounded-3xl w-96">
				...
				<form action="<?php echo constant('URL'); ?>/login/authenticate" method="POST" class="space-y-6">
					<div>
						<input
					...
					<div class="relative" x-data="{ show: true }">
						<input name="contrasenia" placeholder="Contraseña" :type="show ? 'password' : 'text'"
