                ...
                <ul class="px-5">
                    ...
                    <a href="drogueria.html">
                        <li
                            ...
                            <i class="fa-solid fa-suitcase-medical"></i> Droguería
                        </li>
                    </a>
                    ...
                    <a href="heladeria.html">
                        <li
                            class="text-azul p-2 rounded mt-1 flex justify-star items-center gap-2 cursor-pointer font-medium hover:text-blanco hover:bg-azul transition-all">
                            <i class="fa-solid fa-ice-cream"></i> Heladería
                        </li>
                    ...
                    <a href="dulceria.html">
                        <li
                            class="text-azul p-2 rounded mt-1 flex justify-star items-center gap-2 cursor-pointer font-medium hover:text-blanco hover:bg-azul transition-all">
                            <i class="fa-solid fa-candy-cane"></i> Dulcería
                        </li>
                    </a>
                    ...
                    <a href="nevera.html">
                        <li
                            class="text-azul p-2 rounded mt-1 flex justify-star items-center gap-2 cursor-pointer font-medium hover:text-blanco hover:bg-azul transition-all">
                            <i class="fa-regular fa-snowflake"></i> Nevera
                        </li>
                    </a>
