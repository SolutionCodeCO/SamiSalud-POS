...
$proveedores = isset($this->data['proveedores']) ? $this->data['proveedores'] : null;
   ...
   <?php include 'views/partials/sidebar_left.php'; ?>
    ...
    <section id="contenido" class="flex flex-col bg-azul_oscuro_opacidad w-[60%] relative rounded-3xl my-5">
        <article class="w-full pt-5 px-8">
            <h2 class="text-azul_oscuro text-[32px] font-semibold">Proveedores:
            
            </h2>
            <p class="font-medium text-[18px] -mt-2 ">Apartado donde podrás gestionar tus proveedores.</p>
        </article>

        <main class="px-5 pt-10">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-azul_oscuro text-[20px] font-semibold">Proveedores empresariales</h2>
                ...
                <div class="flex items-center justify-center gap-5">
                    ...
                    <div class="group relative inline-block cursor-pointer"
                        onclick="document.getElementById('myModalProveedor').showModal()" id="btn>
            ...
            <?php include 'views/partials/getProveedores_form.php'; ?>
        </main>
